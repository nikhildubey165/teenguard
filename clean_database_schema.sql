-- ============================================
-- PARENT-TEEN CONTROL DATABASE - CLEAN VERSION
-- This is the correct, optimized database schema
-- ============================================
...
-- App usage tracking table (MOST IMPORTANT FOR YOUR ISSUE)
...
SELECT 'All tables have proper indexes for performance' as info;
SELECT 'Ready to use!' as next_step;
