-- ============================================
-- Parent-Teen Work Manager Database
...
-- Users table (both parents and teenagers)
...
-- Parents table (optional, for additional parent-specific data)
...
-- Teenagers table (optional, for additional teenager-specific data)
...
CREATE TABLE IF NOT EXISTS tasks (
  ...
  INDEX idx_teenager (teenager_id),
  INDEX idx_due_date (due_date)
);

-- Time requests table (for requesting additional time on tasks)
...
CREATE TABLE IF NOT EXISTS app_usage (
  ...
  INDEX idx_app_date (app_name, usage_date)
);
...
-- ('Parent User', 'parent@example.com', 'hashed_password', 'parent');
